...
<div class="row-fluid">
    <div class="span12">
	<div class="alert alert-success"><center>Transfer Items To Other Departs</center></div>
       ...
       <fieldset>
			...
			<label class="control-label" style="text-align:left;display: block;">From Department</label>
                    <div class="controls">
                       ...
                       <select id="dept_id1"name="dept_id1" style="width:50% ;">
                            <option value="<?php echo isset($_POST['dept_id1']) ? $_POST['dept_id1'] : '' ?>">Select one</option>
                            <?php
			...
			<label class="control-label" style="text-align:left;display: block;">To Department</label>
                    <div class="controls">
                       ...
                       <select id="dept_id2"name="dept_id2" style="width:50% ;">
                            <option value="<?php echo isset($_POST['dept_id2']) ? $_POST['dept_id2'] : '' ?>">Select one</option>
                            <?php
                            $st = $pdo->prepare("SELECT dept_id,dept_name,room_name,room_no FROM dept_tbl order by room_no");
                            $st->execute();
                            $rows = $st->fetchAll(PDO::FETCH_ASSOC);
           ...
           <div class="control-group">
			...
			<!--<div class="control-group">
					<label class="control-label" style="text-align:left;display: block;">Transfer No</label>
					<div class="controls">
						<input id="tvno" name="tvno" type="text" >
					</div>
					
			</div>-->	
					
			<div class="control-group">
					<label class="control-label" style="text-align:left;display: block;">Indent No</label>
					<div class="controls">
						<input id="issueindentno" name="issueindentno" type="text"  >
					</div>
			...
			<div class="control-group">
					<label class="control-label" style="text-align:left;display: block;">New Issue Voucher No</label>
					<div class="controls">
						IV/<?php echo $currentyear;?>/<input id="ivno" name="ivno" type="text"  >/NIMS
					</div>
					<div class="controls">
...
$message = "Items Transferred Successfully Item Rem"+$itemsrem+"No of Items"+$noofitems+"Voucherno"+$voucherno;

...
<html lang="en">
	<head>
		...
		<link href="./Styles/menu2.css" rel="stylesheet" type="text/css">
		...
		<script type="text/javascript" src="./JScript/stickyheader.js"></script>
		
		<link rel="stylesheet" href="./auto/css/jquery-ui-1.10.3.custom.min.css" />
		<script src="./auto/js/jquery-1.10.2.min.js"></script>	

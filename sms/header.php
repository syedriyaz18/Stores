...
<meta content="KeyWords" name="Nimra medical college" />
  ...
  <div id="demo_wrapper">
   ...
   <ul id="menu">
    ...
    <li><a href="../home.php" class="drop">Home</a><!-- Begin Home Item -->
	...
	<li><a href="#" class="drop">Purchase Items</a><!-- Begin Home Item -->
	...
	<li><a href="#" class="drop">Issue Items</a><!-- Begin Home Item -->
        ...
        <div class="dropdown_2columns align_right"><!-- Begin 3 columns container -->
            ...
            <div class="col_1">
                ...
                <ul class="greybox">
                    ...
                    <li><a href="purchasereports.php">Purchase Reports</a></li>
	...
	<li><a href="#" class="drop">Data BackUP</a><!-- Begin Home Item -->
	...
	<li><a href="../logout.php" class="drop">Log Out</a><!-- Begin Home Item -->

...
{
	$query	=	"SELECT s.stocks_id,i.item_name,s.quantity FROM stocks_tbl s,item_tbl i WHERE s.item_id=i.item_id ORDER BY i.item_name";
}
...
<tr>
	<th>S.No</th><th>Item Name</th><th>Quantity</th>
</tr>
<?php  
...
?>
<tr>
	<td><?php echo (++$i) ?></td><td><?php echo $row['item_name'];?></td><td><?php echo $row['quantity'];?></td>
</tr>

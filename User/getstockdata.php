...
$st = $pdo->prepare("select quantity from nims_store.stocks_tbl where item_name=:item_name");
$st->execute(array ('item_name' => $_POST['item_name']));
...
{
echo json_encode(array ('status' => true, 'quantity' => "0"));
}
